package com.skilldistillery.nationalparks.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/attractions/**/parks").permitAll()  
        .antMatchers(HttpMethod.GET, "/api/attractions/**/comments").permitAll()  
